...
import { NOTIFICATIONS } from "@/api/apiURL"; // Assuming this is the endpoint for notifications
...
const NotificationsPage = () => {
  ...
  const { mutate: sendNotification, isPending } = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: [queryKeys.getNotifications] }); // Refresh notifications list
    },
    onError: (error) => {
